    ...
    with get_connection() as conn:
        ...
        cursor.execute(
            ...
            (
                ...
                json.dumps(record.get("llm_strengths", [])),
                json.dumps(record.get("llm_weaknesses", [])),
                record.get("llm_missing_skills_explanation", ""),
                json.dumps(record.get("llm_interview_questions", [])),
                json.dumps(record.get("shap_contributions", [])),
                current_timestamp(),
                current_timestamp(),
            ),
        )
