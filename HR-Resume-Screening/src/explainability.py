...
_BACKGROUND_DATA = np.array(
    [
        [0.3, 0.3, 0.5, 0.3, 0.4, 0.2, 0.3, 0.5, 0.3, 0.4, 0.4],
        [0.5, 0.5, 0.6, 0.5, 0.5, 0.4, 0.5, 0.5, 0.5, 0.3, 0.5],
        [0.7, 0.7, 0.8, 0.7, 0.7, 0.6, 0.7, 0.7, 0.7, 0.2, 0.7],
        [0.2, 0.1, 0.4, 0.2, 0.3, 0.1, 0.2, 0.4, 0.2, 0.6, 0.3],
        [0.6, 0.4, 0.6, 0.6, 0.6, 0.5, 0.6, 0.6, 0.6, 0.3, 0.6],
    ],
    dtype=np.float32,
)
...
def compute_confidence(probability: float) -> float:
    ...
    """
    distance_from_midpoint = abs(probability - 0.5) * 2
...
def readable_feature_name(feature_key: str) -> str:
    ...
    mapping = {
        ...
        "text_similarity_score": "Resume-JD Similarity",
        "resume_length_norm": "Resume Length",
        "certifications_score": "Certifications",
        "projects_score": "Projects",
        "resume_quality_score": "Resume Quality / Completeness",
        "matched_skills_count_norm": "Matched Skills Count",
        "missing_skills_count_norm": "Missing Skills Count",
        "resume_embedding_norm": "Resume Embedding Strength",
    }
